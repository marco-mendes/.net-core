...
| Recursos Avançados de API Gateways<br />             | Disjuntor (Circuit Breaker)<br /><br />Balanceamento de Carga<br />QoS | - [Exercício 02 de API Gateway](https://github.com/corelioBH/.net-core/blob/master/NET%20Core/API/API%20Gateway%20-%20Exercicio%2002.md) |
