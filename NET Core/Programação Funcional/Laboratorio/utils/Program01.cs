...
namespace LINQ
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Categoria> categorias = new List<Categoria>{new Categoria(0, "Categoria0"), new Categoria(1, "Categoria1"), new Categoria(2, "Categoria2"), new Categoria(3, "Categoria3"), new Categoria(4, "Categoria4"), new Categoria(5, "Categoria5"), new Categoria(6, "Categoria6"), new Categoria(7, "Categoria7"), new Categoria(8, "Categoria8"), new Categoria(9, "Categoria9"), new Categoria(10, "Categoria10")};

            var query = from cat in categorias
                join pdt in produtos on cat equals pdt.CategoriaId
                select new { Categoria = cat.Nome, Produto = pdt.Nome };
